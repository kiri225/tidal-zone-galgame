...
const CHAPTERS = [
  ...
  [31, '应急灯', 'hotel-lobby', 'dark'],
  [32, '只剩值班室', 'hotel-lobby', 'intimate'],
  [33, '有没有当真', 'hotel-lobby', 'intimate'],
  [34, '她先摘名牌', 'hotel-lobby', 'intimate'],
  [35, '雨困值班室', 'hotel-lobby', 'intimate'],
  [36, '习惯还是岸', 'hotel-lobby', 'intimate'],
  [37, '黎明交班', 'seaside-dawn', 'cold'],
  [38, '潮间带·客房', 'tide-pools', 'warm'],
  [39, '假装前台', 'hotel-lobby', 'normal'],
  [40, '同事的眼光', 'hotel-lobby', 'cold'],
  [41, '备用房卡', 'hotel-lobby', 'warm'],
  [42, '买家皮鞋', 'hotel-lobby', 'cold'],
  [43, '监控死角', 'hotel-lobby', 'rain'],
